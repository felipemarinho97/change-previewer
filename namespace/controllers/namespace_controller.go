...
import (
	...
	changepreviewergithubiov1 "change-previewer.github.com/namespace/api/v1"
)
...
//+kubebuilder:rbac:groups=change-previewer.github.io.change-previewer.github.io,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=change-previewer.github.io.change-previewer.github.io,resources=namespaces/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=change-previewer.github.io.change-previewer.github.io,resources=namespaces/finalizers,verbs=update
...
func (r *NamespaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Fetch the changepreviewergithubiov1.Namespace instance
	var namespace changepreviewergithubiov1.Namespace
...
func (r *NamespaceReconciler) createNamespace(namespace *changepreviewergithubiov1.Namespace) (*corev1.Namespace, error) {
...
func (r *NamespaceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &corev1.Namespace{}, ownerKey, func(rawObj client.Object) []string {
		...
		// ...make sure it's a NS...
		if (owner.APIVersion != apiGVStr && owner.APIVersion != "change-previewer.github.io.change-previewer.github.io/v1") || owner.Kind != "Namespace" {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&changepreviewergithubiov1.Namespace{}).
